...
Ollama — local AI inference (runs on your own machine)
ngrok — tunnels your local Ollama to the internet so your phone can reach it
Hosted on Cloudflare Pages / Netlify (free tier)

Setup
1. Clone the repo
bashgit clone https://github.com/YOUR_USERNAME/hayai.git
cd hayai
2. Install Ollama
...
6. Deploy the PWA
Drag the project folder to Cloudflare Pages or Netlify. Both are free.
Then on your phone:
...
Tap ⚙️ → paste your ngrok URL → Save
Player tab — paste a YouTube URL to load a video, type Japanese text below to analyze it
Review tab — SRS flashcard review of your saved words
Vocab tab — all saved words with select/delete management
Dictionary tab — instant local lookup or AI-powered deep lookup
...
Built by Ahmed • Inspired by HayaiLearn
